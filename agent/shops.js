...
const CHAINS = [
  ...
  { match: /walgreens/i, brand: 'Walgreens', portal: 'https://photo.walgreens.com/store/document-printing', notes: 'Document printing via photo site, same-day pickup, B&W and color letter size only.' },
  { match: /\bcvs\b/i, brand: 'CVS', portal: 'https://www.cvs.com/photo/documents', notes: 'Document printing via photo site, same-day pickup, letter size only.' },
  { match: /walmart/i, brand: 'Walmart', portal: 'https://photos.walmart.com/', notes: 'Photo center; most stores do NOT print documents. Treat as last resort unless verified.' },
