...
5. Submission method rules:
   ...
   For any OTHER candidate that is a public library (name contains "library") WITHOUT a library_print field: most US public libraries take email-to-print via EnvisionWare MobilePrint at "<code>-bw@ewprints.com" (and "<code>-color@ewprints.com"), or via a Princh web portal. Use WebSearch/WebFetch to find THAT library's own ewprints address or Princh link on its website. If you find a real "@ewprints.com" address on an official library page, use method "email" with it, automatable=true. If you only find a Princh portal, use method "portal" with that URL. Never guess or construct an ewprints code you did not see on the library's page.
